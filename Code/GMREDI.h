...
C WHY hacks
      LOGICAL GEOM_DepthTaper
      LOGICAL UseVarLmbda
      LOGICAL GEOM_SlopeAware
      LOGICAL GEOM_SloAwa_Burger
      LOGICAL ene_const
      LOGICAL UseMLTrhines
      LOGICAL Visb_SlopeAware
      LOGICAL GMconst_SlopeAware
C end WHY hacks
...
C WHY hacks
     &                   GEOM_DepthTaper, UseVarLmbda,
     &                   GEOM_SlopeAware, GEOM_SloAwa_Burger,
     &                   ene_const, UseMLTrhines,
     &                   Visb_SlopeAware, GMconst_SlopeAware,
C end WHY hacks
...
C WHY hacks
      _RL GEOM_Varlmbda(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
